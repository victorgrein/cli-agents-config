...
description: Step-by-step workflow for creating a new CrewAI crew from specification with validation checklist
license: MIT
...
Provides a step-by-step workflow for creating a new CrewAI crew from scratch. Includes goal definition, agent design, task configuration, and validation checklists.

## When to Use This Skill

- Creating a new crew from requirements
- Designing agents for a specific use case
- Setting up task workflows
- Validating crew configuration
- Following best practices for crew design
...
- `crewai-agents` - Agent configuration details
- `crewai-tasks` - Task configuration details
- `crewai-processes` - Process type selection
- `crewai-tools` - Tool creation and assignment
