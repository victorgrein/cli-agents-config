---
name: crewai-project-structure
description: Standard project structures for CrewAI crews and flows with file contents and directory purposes
license: MIT
...
Provides standard project structures for CrewAI crews and flows. Includes directory layouts, file contents, and configuration templates.
...
- `crewai-cli` - Creating project structure
