---
name: crewai-migration
description: Migrate CrewAI projects between architectures - crew to flow, code to YAML, monolithic to modular
license: MIT
...
Provides guidance for migrating CrewAI projects to standard structures. Includes crew-to-flow migration, code-to-YAML configuration, monolithic-to-modular refactoring, and version upgrades.

## When to Use This Skill

- Converting standalone crew to flow architecture
- Moving inline code definitions to YAML
- Breaking large crews into modular components
- Upgrading to latest CrewAI version
...
- `crewai-project-structure` - Standard project structures
- `crewai-flows` - Flow creation
- `crewai-crews` - Crew configuration
- `crewai-cli` - CLI commands
