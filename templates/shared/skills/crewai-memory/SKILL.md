---
name: crewai-memory
description: Configure CrewAI memory system with short-term, long-term, and entity memory for enhanced agent capabilities
license: MIT
...
Provides comprehensive guidance for configuring CrewAI's memory system - enabling agents to store, recall, and leverage information across interactions for enhanced decision-making and task execution.

## When to Use This Skill

- Enabling memory for complex, multi-step tasks
- Configuring embedder providers
- Building agents that learn over time
- Implementing customer support with history
- Creating research agents that build knowledge
...
- `crewai-llms` - LLM and embedder configuration
