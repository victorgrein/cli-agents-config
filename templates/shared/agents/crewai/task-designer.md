---
name: task-designer
description: Specialized subagent for designing and configuring CrewAI tasks. Expert
  in task descriptions, expected outputs, context passing, and task execution patterns.
tools:
- Read
- Write
- Edit
