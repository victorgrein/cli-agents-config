...
description: Specialized subagent for migrating and refactoring CrewAI projects. Expert
  in project structure standardization, flow migration, modularization, and codebase
  reorganization.
tools:
- Read
- Write
